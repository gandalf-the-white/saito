...
mcp> Crée une VM nommée web01 avec 2 CPU et 4 Go de RAM, puis montre-moi le contenu du fichier Terraform généré.
mcp> Create a VM named web01 with 2 CPUs and 4 GB of RAM, then show me the contents of the generated terraform file.
...
#+end_src
We probably add in the /asdf:*central-registry*/ our directory just before.
